      ...
      {edit ? (
        ...
        <tr class="bg-white border-b bg-gray-800 border-gray-700 font-md text-center">
          ...
          <td class="px-6 py-4 bg-gray-300 text-gray-800">
            <button
              onClick={handleEdit}
              className="w-1/2 self-auto text-white bg-teal-500 hover:bg-teal-700 focus:outline-none focus:ring-blue-800 rounded-lg font-bold text-sm px-5 py-2.5 text-center"
            >
              Edit
            </button>
          </td>

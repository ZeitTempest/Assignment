    ...
    <>
      <tr class="border-b bg-gray-800 border-gray-700 text-gray-800 whitespace-nowrap font-md text-center">
        ...
        <td class="px-6 py-4 bg-gray-300 text-gray-800">
          <input type="password" onChange={e => setPassword(e.target.value)} placeholder="New password" class="text-center border border-blue-gray-300  block placeholder-blue-gray-600 focus:ring-blue-500 focus:border-blue-600 focus:bg-blue-gray-200 rounded-lg p-2.5 bg-gray-200" />
        </td>
        <td class="px-6 py-4 bg-gray-300 text-gray-800">
          <input type="email" onChange={e => setEmail(e.target.value)} defaultValue={props.email} placeholder="new email" class="text-center border border-blue-gray-300  block placeholder-blue-gray-600 focus:ring-blue-500 focus:border-blue-600 focus:bg-blue-gray-200 rounded-lg p-2.5 bg-gray-200" />
        </td>
        <td class="px-6 py-4 bg-gray-300 text-gray-800 flex justify-center">
          <Autocomplete clearIcon={false} sx={{ width: "400px" }} onChange={handleGroupChange} options={props.groupList} defaultValue={props.userGroups} multiple className="border text-white block text-xs rounded-lg bg-blue-gray-50 border-blue-gray-300" renderInput={params => <TextField {...params} />} />
        </td>
        <td class="px-6 py-4 bg-gray-300 text-gray-800">

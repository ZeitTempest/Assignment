        ...
        <div className="flex space-x-6 sm:p-8 items-center justify-end">
          <div className="flex-col space-y">
            ...
            <input
              ...
              name="username"
              id="username"
              className="border text-white sm:text-sm rounded-lg block w-full p-2.5 bg-blue-gray-500 border-blue-gray-300 placeholder-blue-gray-200 focus:bg-blue-gray-400 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div className="flex-col space-y">
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField label="Select Groups.." {...params} />
              )}
            />
          </div>
          <div>
            ...
            <button
              ...
              className="w-40 self-auto text-white bg-teal-500 hover:bg-teal-700 focus:outline-none focus:ring-blue-800 rounded-lg font-bold text-sm px-5 py-2.5 text-center"
            >
              Create User
            </button>
          </div>

            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  id="password"
                  placeholder="••••••••"
                  className="border border-blue-gray-300 text-white sm:text-sm rounded-lg  block w-full p-2.5 bg-blue-gray-500 border-blue-gray-100 placeholder-blue-gray-200 focus:bg-blue-gray-400 focus:ring-blue-500 focus:border-blue-500"
                  required=""
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full text-white bg-teal-500 hover:bg-teal-700 focus:ring-blue-gray-200 focus:ring-4 focus:outline-none font-medium rounded-lg text-md px-5 py-2.5 text-center focus:ring-blue-800"
              >
                Sign in
              </button>
            </form>

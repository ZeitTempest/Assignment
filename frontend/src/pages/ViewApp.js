  ...
  return (
    <Page title="View Application">
      <section className="bg-blue-gray-100 flex justify-center items-center h-screen w-screen">
        <div className="rounded-lg sm:max-w-lg xl:p-0 shadow border bg-white border-gray-300 items-center flex w-screen h-3/5">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div className="flex-col space-y">
              ...
              <input
                ...
                name="appDescription"
                id="appDescription"
                className="border text-white sm:text-sm rounded-lg block h-auto p-20 bg-blue-gray-500 border-blue-gray-300 placeholder-blue-gray-200 focus:bg-blue-gray-400 focus:ring-blue-500 focus:border-blue-500"
